              ...
              <Tooltip>
                <TooltipTrigger>
                  <Button
                    ...
                    size={"sm"}
                    variant={"link"}
                    className={"h-8 w-8 hover:bg-primary/5 rounded-lg bg-background border border-border  "}
                  >
                    <Pen size={18} />
                  </Button>
                </TooltipTrigger>
              ...
              <Tooltip>
                <TooltipTrigger>
                  <Button
                    ...
                    variant={"link"}
                    className={"h-8 w-8 text-destructive! rounded-lg bg-background border border-border hover:bg-destructive/5"}
                  >
                    <Trash2 size={18} />
                  </Button>
                </TooltipTrigger>
